...
function start() {
    ...
    headers.append("X-RapidAPI-Key", "8dac24d263msh177820a6dda2743p16a06ejsnb4c22c1d66f2");
    ...
    fetch(`https://deezerdevs-deezer.p.rapidapi.com/search?q=${storage.getItem("artist")}`, opciones)
        ...
        .then((json) => {
            ...
            if (data.length >0) {
                ...
                alert("Artista desconocido No Found");
                window.sessionStorage.clear(); window.location = "index.html";
