class AudioPlayer {
    ...
    set buttons(btns) {
        let actions = {
            ...
            back: () => {this.index--; this.player.play(); this._toggleIcon(this.buttons.volume, "fa-volume-up", "fa-volume-mute")},
            next: () => {this.index++; this.player.play(); this._toggleIcon(this.buttons.volume, "fa-volume-up", "fa-volume-mute")},
